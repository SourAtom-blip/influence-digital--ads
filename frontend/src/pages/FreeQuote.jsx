    ...
    <div className="bg-surface">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden min-h-[50vh] flex items-center">
        ...
        <div className="max-w-container-max mx-auto px-4 sm:px-6 lg:px-margin-desktop relative z-10">
          ...
          <h1 className="font-display-lg text-3xl sm:text-4xl lg:text-display-lg text-white mb-6 max-w-2xl">{t.heroHeadline}</h1>
          <p className="text-outline-variant text-base sm:text-lg max-w-2xl">{t.heroSubtext}</p>
        </div>
      </section>

      {/* Info + Form */}
      <section className="py-20 bg-white">
        <div className="max-w-container-max mx-auto px-4 sm:px-6 lg:px-margin-desktop grid grid-cols-1 lg:grid-cols-3 gap-16">
          {/* Info Panel */}
          <div>
